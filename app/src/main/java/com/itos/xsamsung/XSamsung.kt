...
import com.itos.xsamsung.datatype.AppInfo
import com.itos.xsamsung.ui.theme.OriginPlanTheme
import com.itos.xsamsung.utils.NetUtils
import com.itos.xsamsung.utils.OData
import com.itos.xsamsung.utils.OLog
import com.itos.xsamsung.utils.OPackage
import com.itos.xsamsung.utils.OPackage.getAppIconByPackageName
import com.itos.xsamsung.utils.OShizuku
import com.itos.xsamsung.utils.OShizuku.checkShizuku
...
class XSamsung : AppCompatActivity() {
...
//                                modifier = Modifier.alpha(if (currentDestination?.route == "About") 1f else 0f)
    ...
    companion object {
        ...
        lateinit var app: XSamsung private set
    }
}
